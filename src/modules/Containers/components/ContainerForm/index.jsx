    ...
    <form className="flex-row" onSubmit={props.handleSubmit(props.onSubmit)} autoComplete="off">
      <div className="flex-row center-center">
        <Card className="flex-10 flex-xs-12 flex-sm-12">
          <CardTitle title={<span><span>{props.title}</span>{!props.editMode ? null : <ContainerActions inContainerView state={container.properties.status} container={container} {...props} />}</span>} subtitle={container.id ? container.id : null} />
