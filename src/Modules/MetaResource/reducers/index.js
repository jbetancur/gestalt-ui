...
export default combineReducers({
  ...
  lambda: reducerFactory(['fetch', 'create', 'update'], 'lambda', 'lambda', lambdaModel),
  lambdaProvider: reducerFactory(['fetch', 'create'], 'provider', 'lambda_provider', providerModel),
  lambdasDropDown: reducerFactory(['fetch'], 'lambdas', 'lambdas_dropdown', [], true, []),
  apis: reducerFactory(['fetch', 'delete'], 'apis', 'apis', []),
  api: reducerFactory(['fetch', 'create', 'update'], 'api', 'api', apiModel),
  apiEndpoints: reducerFactory(['fetch', 'delete'], 'apiEndpoints', 'apiEndpoints', []),
  apiEndpoint: reducerFactory(['fetch', 'create'], 'apiEndpoint', 'apiEndpoint', apiEndpointModel),
  ...
  provider: reducerFactory(['fetch', 'create', 'update'], 'provider', 'provider', providerModel),
  ...
  secret: reducerFactory(['fetch', 'create', 'update'], 'secret', 'secret', secretModel),
