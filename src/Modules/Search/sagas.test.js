...
describe('Search Sagas', () => {
  describe('searchUser Sequence', () => {
    ...
    it('should return a payload and dispatch a reject status when there is an error', () => {
      ...
      expect(resultError.value).toEqual(
        put({ type: DO_SEARCHUSERS_REJECTED, payload: error })
      );
    });
  });
  ...
  describe('searchAsset Sequence', () => {
    ...
    it('should return a payload and dispatch a success status', () => {
      ...
      expect(result.value).toEqual(
        put({
          type: DO_SEARCHASSETS_FULFILLED,
          payload: [{ id: '1', name: 'morty' }],
        })
      );
    });
    ...
    it('should return a payload and dispatch a reject status when there is an error', () => {
      ...
      expect(resultError.value).toEqual(
        put({ type: DO_SEARCHASSETS_REJECTED, payload: error })
      );
    });
  });
