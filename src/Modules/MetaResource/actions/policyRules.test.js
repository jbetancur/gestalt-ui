...
describe('Policy Rule Actions', () => {
  it('should request UNLOAD_POLICYRULES', () => {
    ...
    expect(actions.unloadPolicyRules()).toEqual(expectedAction);
  });
  ...
  it('should request UNLOAD_POLICYRULE', () => {
    ...
    expect(actions.unloadPolicyRule()).toEqual(expectedAction);
  });
  ...
  it('should request FETCH_POLICYRULES_REQUEST', () => {
    ...
    expect(actions.fetchPolicyRules('iamfqon', '1')).toEqual(expectedAction);
  });
  ...
  it('should request FETCH_POLICYRULE_REQUEST', () => {
    ...
    expect(actions.fetchPolicyRule('iamfqon', '1', '2')).toEqual(expectedAction);
  });
  ...
  it('should handle CREATE_POLICYRULE_REQUEST', () => {
    ...
    expect(actions.createPolicyRule('iamfqon', '1', { name: 'test' })).toEqual(expectedAction);
  });
  ...
  it('should handle UPDATE_POLICYRULE_REQUEST', () => {
    ...
    expect(actions.updatePolicyRule('iamfqon', '1', '2', [])).toEqual(expectedAction);
  });
  ...
  it('should handle DELETE_POLICYRULE_REQUEST', () => {
    ...
    expect(actions.deletePolicyRule('iamfqon', '1', '2')).toEqual(expectedAction);
  });
  ...
  it('should handle DELETE_POLICYRULES_REQUEST', () => {
    ...
    expect(actions.deletePolicyRules([], 'iamfqon', '1')).toEqual(expectedAction);
  });
});
