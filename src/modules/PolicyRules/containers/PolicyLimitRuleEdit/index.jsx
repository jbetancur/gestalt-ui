...
class PolicyRuleEdit extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return pending ? <CircularActivity id="policyRule-load" /> : <PolicyLimitRuleForm editMode title={policyRule.name} submitLabel="Update" cancelLabel="Cancel" onSubmit={values => this.updatePolicyRule(values)} {...this.props} />;
  }
}
