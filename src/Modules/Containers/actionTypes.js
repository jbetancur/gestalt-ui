...
export const CREATE_CONTAINERS_REQUEST = `${PREFIX}CREATE_CONTAINERS_REQUEST`;
export const CREATE_CONTAINERS_FULFILLED = `${PREFIX}CREATE_CONTAINERS_FULFILLED`;
export const CREATE_CONTAINERS_REJECTED = `${PREFIX}CREATE_CONTAINERS_REJECTED`;
